...
import { Save, ArrowLeft, Eye } from 'lucide-vue-next';
...
const form = useForm({
    ...
    ac_work: props.serviceReport.ac_work,
    plumbing_work: props.serviceReport.plumbing_work,
    paint_work: props.serviceReport.paint_work,
    electrical_work: props.serviceReport.electrical_work,
    civil_work: props.serviceReport.civil_work,
    job_details: props.serviceReport.job_details,
});

const submit = () => {
    form.put(`/service-reports/${props.serviceReport.id}`);
};
</script>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <Input
                                    ...
                                    :value="serviceReport.service_report_number"
                                    type="text"
                                    class="bg-muted"
                                    readonly
                                />
