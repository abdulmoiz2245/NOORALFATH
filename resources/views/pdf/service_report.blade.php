    ...
    <style type="text/css">
        * {
        ...
        .lined-box {
            ...
            line-height: 23px;
            min-height: 150px;
            background-image: repeating-linear-gradient(to bottom, transparent, transparent 26px, #ccc 27px);
        }
        @media print {
            body {
...
<body style="margin:30px">
    <table style="width:100%">
        <tr style="width:100%">
            <td> 
                <h1 style="padding-top: 20px;float: left;padding-left: 7pt;text-indent: 0pt;text-align: left;">
                    <table border="0" style="padding-left:0px" cellspacing="0" cellpadding="0">
                        <tr>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top:10px">
                    <tr>
                        ...
                        <td style="width: 50%; vertical-align: top; line-height: 12px;">
                            {{-- <table style="width: 100%; border-collapse: collapse;">
                                <tr>
                                    ...
                                    <td style="padding: 3pt 6pt 0 6pt; text-align: left;"><p> : &nbsp;&nbsp;</p></td>
                                </tr>
                        ...
                        <td style="width: 40%;vertical-align: top;border-right: 1px solid black;padding-right: 10px;padding-left: 100px;">
                            ...
                            <p style="text-align: right;">{{ \Carbon\Carbon::parse('now')->format('d/m/Y') }}</p>
                        ...
                        <td style="width: 60%; vertical-align: top; padding-left: 15px;line-height: 13px;">
    ...
    <table style="width: 100%; border-collapse: collapse; ;">
        <tr>
            <td style="width: 20%; padding-left: 5pt; text-align: left; ">
                <h3 style="font-size: 15px; margin: 0;">Work Type:</h3>
            </td>
    ...
    <table style="width: 100%; margin-top: 30px; position:fixed; bottom: 20%; left: -65%; right:80%;  border-top: 1px solid black; padding-top: 10px;">
        <tr>
